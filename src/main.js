...
async function init() {
    ...
    function handleSessionCheck() {
        if (localStorage.getItem("auth") !== correctPassword || localStorage.getItem("vertex_sso") !== 'true') {
    ...
    handleSessionCheck();
        ...
        document.getElementById('changelog-btn').addEventListener('click', toggleChangelog);
